...
const THEATRES = [
  {
    ...
    name: "INOX Laserplex",
    distance: "2.5 km",
    amenities: ["parking", "food", "wheelchair"],
    formats: [
      {
        name: "IMAX 3D",
        shows: [
          { time: "10:30 AM", type: "morning", status: "filling" },
          { time: "02:15 PM", type: "afternoon", status: "available" },
          { time: "07:30 PM", type: "evening", status: "fast-filling" },
          { time: "10:45 PM", type: "evening", status: "available" }
        ]
      },
      {
        name: "2D",
        shows: [
          { time: "09:00 AM", type: "morning", status: "available" },
          { time: "01:00 PM", type: "afternoon", status: "available" },
          { time: "05:15 PM", type: "evening", status: "filling" },
        ]
      }
    ]
  },
  {
    ...
    name: "PVR ICON",
    distance: "4.8 km",
    amenities: ["food", "lounge"],
    formats: [
      {
        name: "4DX 3D",
        shows: [
          { time: "11:00 AM", type: "morning", status: "available" },
          { time: "03:45 PM", type: "afternoon", status: "fast-filling" },
          { time: "08:30 PM", type: "evening", status: "almost-full" }
        ]
      }
    ]
  }
          ...
          <div>
            ...
            <div className="relative">
              ...
              >
                ...
                <option value="Delhi-NCR" className="bg-[#141414]">Delhi-NCR</option>
                <option value="Bengaluru" className="bg-[#141414]">Bengaluru</option>
                ...
                <option value="Ahmedabad" className="bg-[#141414]">Ahmedabad</option>
              </select>
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                  <div>
                    ...
                    <div className="flex items-center gap-4 mt-2 text-xs text-white/50">
                      <span className="flex items-center gap-1"><MapPin size={12} /> {theatre.distance}</span>
                      <div className="flex items-center gap-2">
                        {theatre.amenities.includes("food") && <Coffee size={12} title="Food & Beverage" />}
                        {theatre.amenities.includes("parking") && <Car size={12} title="Parking" />}
                        {theatre.amenities.includes("wheelchair") && <Accessibility size={12} title="Wheelchair Access" />}
                      </div>
                    </div>
                  </div>
                </div>
