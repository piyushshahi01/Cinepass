...
function PrimaryButton({ label = "Book Now", full = false, icon }) {
  return (
    <button
    ...
    <>
      ...
      >
        <div className="flex items-center justify-between px-6 py-5 max-w-6xl w-full">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <PrimaryButton label="Book Tickets" />
          </div>
      ...
      {open && (
        <div className="md:hidden fixed inset-x-0 top-[72px] z-40 bg-black/95 backdrop-blur-lg border-b border-white/10 px-6 py-4 flex flex-col gap-3">
          ...
          <div className="pt-2">
            <PrimaryButton label="Book Tickets" full />
          </div>
        </div>
      )}
    </>
    ...
    <section className="pt-[72px] text-center flex flex-col items-center relative z-10 px-6 overflow-hidden" style={{ minHeight: "100vh" }}>
      ...
      >
        <div className="liquid-glass rounded-full px-5 py-3 flex items-center gap-3">
          ...
          />
          <button className="rounded-full bg-[#e11d48] text-white text-xs font-medium px-4 py-1.5 hover:bg-[#be123c] transition-colors">
            Search
          </button>
        </div>
      </motion.div>
      ...
      >
        <div className="flex flex-wrap justify-center gap-3">
          <PrimaryButton label="Browse Movies" />
          <button className="group inline-flex items-center justify-center gap-2 rounded-full border border-white/15 text-white font-medium text-sm px-5 py-3 hover:bg-white/5 transition-all">
    ...
    <>
      ...
      <div className="relative min-h-screen text-white" style={{ overflowX: "clip" }}>
        ...
        <div className="relative z-[3] flex flex-col">
          ...
          <ContinueWatching onOpenDetail={setSelectedMovie} />
          <GenreGrid />
          ...
          {/* Footer */}
          <footer className="relative z-10 border-t border-white/[0.08] py-12 px-6 max-w-6xl mx-auto w-full">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between pt-6 border-t border-white/[0.06]">
              ...
              <div className="flex items-center gap-4 mt-3 md:mt-0">
                {[
                  { icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>, label: "Instagram" },
                  { icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"/></svg>, label: "Twitter" },
                  ...
                  <a
                    key={label}
                    href="#"
                    className="w-8 h-8 rounded-full border border-white/10 bg-white/[0.03] flex items-center justify-center text-white/40 hover:text-white hover:border-white/20 transition-all"
                    title={label}
                  >
                    {icon}
                  </a>
