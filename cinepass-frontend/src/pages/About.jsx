...
export default function About() {
  return (
    <div className="min-h-screen pt-28 px-6 md:px-12 xl:px-20 text-white max-w-5xl mx-auto pb-20">
      ...
      >
        <h1 className="text-4xl md:text-5xl font-bold mb-4">About OneCinema</h1>
      ...
      <div className="grid md:grid-cols-2 gap-12 mb-20">
        ...
        >
          ...
          <p className="text-white/70 leading-relaxed">
            OneCinema began with a simple idea: booking a movie ticket should be as magical as the movie itself. We were tired of clunky interfaces, hidden fees, and stressful seat selection processes.
          </p>
          <p className="text-white/70 leading-relaxed">
      ...
      >
        ...
        <p className="text-white/60 max-w-2xl mx-auto mb-8">
          OneCinema is built using the bleeding edge of web technology. A fully responsive React architecture powered by Framer Motion, TailwindCSS, and React Query, seamlessly integrating with the TMDB API.
        </p>
