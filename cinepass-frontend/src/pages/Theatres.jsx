        ...
        {loading && theatres.length === 0 ? (
          ...
          theatres.map((t, i) => (
            ...
            >
              ...
              <button 
                onClick={() => navigate(`/theatre/${t.id}`, { state: { theatre: t } })}
                className="w-full py-2.5 rounded-xl border border-white/10 text-xs font-medium hover:bg-white/10 transition-colors mt-auto"
              >
                View Showtimes
              </button>
            </motion.div>
